...
This educational application is designed to assist high school science students in learning how to define science terms with the required specific keywords based on the curriculum they're doing (e.g., Cambridge, Edexcel, CAPS, etc.). The primary focus is on improving students' understanding of the required definitions for various science concepts. 
...
[Software Demo Video] (https://youtu.be/dj9DvsEJdF4)
